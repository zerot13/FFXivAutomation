...
namespace FFXivAutomation
{
    public static class KeyboardInput
    {
        ...
        public static void PressKey(KeyboardInput.ScanCodeShort key, int interval)
        {
        ...
        public static void KeyDown(ScanCodeShort key)
        {
        ...
        public static void KeyUp(ScanCodeShort key)
        {
        ...
        public static void SenKeyboardInput_WDOWN()
        {
            Input[] inputs = new Input[1];
            Input input = new Input();
        ...
        public static void SenKeyboardInput_WUP()
        {
            Input[] inputs = new Input[1];
            Input input = new Input();
